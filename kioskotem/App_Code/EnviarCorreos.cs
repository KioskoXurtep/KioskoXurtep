...
public class EnviarCorreos
{
    ...
    public static Boolean enviarCorreo(string email, string pagina, string asunto)
    {
        ...
        try
        {
            ...
            msg.From = new MailAddress("soporte@mbcgroup.mx", "Xurtep", Encoding.UTF8);
            msg.Subject = asunto;
    ...
    public static string paginaConfirmar(string NombresContacto, string NombreProducto, string ClaveAcceso)
    {
        ...
        @"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>" +
            ...
            "<div class='plantilla'>" +
                "<div class='banner'><img src='http://www.xurtep.net/xurtep/imagenes/logooperadora.png ' alt='" + NombreProducto + "' /></div>" +
                ...
                "<div class='contenido'>" +
                    "<p>" +
                        ...
                        "<br />" +
                        "<span style='text-align:center;'><a href='http://www.xurtep.net/xurtep/Verificar.aspx?ca=" + ClaveAcceso + "' target='_new'>http://www.xurtep.net/xurtep/Verificar.aspx</a></span>" +
                        "<br />" +
    ...
    public static string paginaRecuperar(string NombresContacto, string ClaveAcceso)
    {
        ...
        @"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>" +
           ...
           "<div class='plantilla'>" +
               "<div class='banner'><img src='http://www.xurtep.net/xurtep/imagenes/logooperadora.png ' alt='Xurtep' /></div>" +
               "<div class='titulo'>Gracias por registrarse.</div>" +
               "<div class='contenido'>" +
                   "<p>" +
                       "Estimado: <strong>" + NombresContacto + " " + "</strong>" +
                       "<br />" +
                       "Para continuar con el proceso de registro en <strong>Xurtep</strong>, es necesario nos confirme haciendo click en el siguiente link " +
                       "<br />" +
                       "<span style='text-align:center;'><a href='http://www.xurtep.net/xurtep/CambiarPassword.aspx?ca=" + ClaveAcceso + "' target='_new'>http://www.xurtep.net/xurtep/CambiarPassword.aspx</a></span>" +
                       "<br />" +
                       "o copie y pegue el contenido en la barra de navegaci&oacute;n de su explorador." +
                   "</p>" +
               "</div>" +
    ...
    public static string paginaCambio(string NombresContacto)
    {
        ...
        @"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>" +
            ...
            "<div class='plantilla'>" +
                "<div class='banner'><img src='http://www.xurtep.net/xurtep/imagenes/logooperadora.png ' alt='" +" "  + "' /></div>" +
                ...
                "<div class='contenido'>" +
                    "<p>" +
                        ...
                        "<br />" +
                        "<br />" +
                        "Se ha vinculado este correo a su cuenta en <strong>www.xurtep.net</strong>  correctamente" +
                    "</p>" +
                "</div>" +
                "<div align='center'>" +
                    "<p>" +
