...
namespace kioskotem.codigo
{
    public partial class codigo : System.Web.UI.Page
    {
        ...
        protected void cmdaceptar_Click(object sender, EventArgs e)
        {
            ...
            //    else
            //    {
            //        ScriptManager.RegisterStartupScript(this.UpdatePanel2, typeof(string), "alerta", "alert('Datos no guardados, intente de nuevo');", true);
            //    }
            //}
            //else
            //{
            //    ScriptManager.RegisterStartupScript(this.UpdatePanel2, typeof(string), "alerta", "alert('Favor de aceptar los terminos y condiciones para continuar');", true);
            //}
        }
