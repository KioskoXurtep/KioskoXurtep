        ...
        protected void dtgnominas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Select")
                {
                    ...
                    Session["ruta"] = "pagosnxurtep/" + sa + ".pdf";
                    String path = Server.MapPath("../pagosnxurtep") + "\\" + sa + ".pdf";

                    String path2 = "../pagosnxurtep/" + sa + ".pdf";
                ...
                if (e.CommandName == "Delete")
                {
                    ...
                    Session["ruta"] = "pagosnxurtep/" + sindicato + ".xml";
                    String path = Server.MapPath("../pagosnxurtep") + "\\" + sindicato + ".xml";
                    String path2 = "../pagosnxurtep/" + sindicato + ".xml";
